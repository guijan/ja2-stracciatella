...
{
	STLOGI("Handle NPC trigger {} {}", ubTargetNPC, ubTargetRecord);
...
{
	// OK, Move to gridNo!
	STLOGI("OK, Move to gridNo {}", usGridNo);
	...
	STLOGI("set AbsoluteFinalDestination to {}", usGridNo);
}
...
add_log:
			...
			case NPC_ACTION_WALTER_GIVEN_MONEY:
				...
				break;
			default:
				STLOGW("No code support for NPC action {}", usActionCode);
				break;
		}
	}
}
